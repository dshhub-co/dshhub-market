window.__ModuleLoader__.load({ id: "dshhub-market", factory: (require) => {
		...
		*/
		...
		var Market_module_css_default = {
			...
			"fabModalBody": "T2zNLW_fabModalBody",
		...
		*/
		...
		function StoreFab({ t, market }) {
			...
			}), open && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				open: true,
				onClose: () => setOpen(false),
				title: t("fabModalTitle"),
				className: Market_module_css_default.fabModalCard,
				contentClassName: Market_module_css_default.fabModalBody,
