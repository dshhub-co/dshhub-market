window.__ModuleLoader__.load({ id: "dshhub-market", factory: (require) => {
		...
		*/
		...
		const css = ".T2zNLW_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative}.T2zNLW_head{flex-direction:column;gap:12px;padding:4px 4px 12px;display:flex}.T2zNLW_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.T2zNLW_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.T2zNLW_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.T2zNLW_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.T2zNLW_tab.T2zNLW_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.T2zNLW_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.T2zNLW_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.T2zNLW_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.T2zNLW_body{flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.T2zNLW_fab{z-index:500;cursor:pointer;color:#fff;background:linear-gradient(135deg,#4f7cff,#7c3aed);border:1px solid #ffffff2e;border-radius:999px;align-items:center;gap:8px;height:40px;padding:0 16px;transition:transform .15s,box-shadow .15s;display:flex;position:fixed;bottom:72px;left:16px;box-shadow:0 6px 18px #4c6eff59}.T2zNLW_fab:hover{transform:translateY(-2px);box-shadow:0 10px 24px #4c6eff73}.T2zNLW_fab:active{transform:translateY(0)}.T2zNLW_fabLabel{white-space:nowrap;font-size:13px;font-weight:600}.T2zNLW_fabModalCard{overflow:hidden;width:min(960px,94vw)!important;max-width:96vw!important;padding:0!important}.T2zNLW_fabModalHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:space-between;align-items:center;gap:10px;padding:14px 18px;display:flex}.T2zNLW_fabModalTitle{font-size:16px;font-weight:600}.T2zNLW_fabModalPanel{height:min(76vh,700px);padding:0 18px 18px;display:block;overflow:auto}.T2zNLW_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.T2zNLW_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.T2zNLW_cats{margin:0 -4px 2px;padding:12px 4px 4px}.T2zNLW_tiersRow{flex-wrap:wrap;gap:6px;margin:0 -4px;padding:0 4px 4px;display:flex}.T2zNLW_tierTag{margin-right:6px}.T2zNLW_tierTag.T2zNLW_tierAppearance{color:#7c5cd6;border-color:#a78bfa73}.T2zNLW_tierTag.T2zNLW_tierUtility{color:#3b6fe0;border-color:#4f7cff73}.T2zNLW_tierTag.T2zNLW_tierAgentic{color:#0e9f6e;border-color:#34d39980}.T2zNLW_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.T2zNLW_star{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.T2zNLW_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.T2zNLW_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.T2zNLW_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.T2zNLW_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.T2zNLW_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.T2zNLW_catsCollapsed{max-height:62px;overflow:hidden}.T2zNLW_catsToggle.T2zNLW_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.T2zNLW_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:0 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.T2zNLW_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:8px;flex:none;max-width:260px;height:150px}.T2zNLW_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.T2zNLW_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.T2zNLW_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.T2zNLW_grid{grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:12px;display:grid}.T2zNLW_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.T2zNLW_themesGrid{margin-bottom:12px}.T2zNLW_swatches i{flex:1}.T2zNLW_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.T2zNLW_row1{align-items:center;gap:10px;min-width:0;display:flex}.T2zNLW_installBtn.T2zNLW_installBtn{min-width:92px}.T2zNLW_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.T2zNLW_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.T2zNLW_byline{align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.T2zNLW_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.T2zNLW_metaInline,.T2zNLW_owner{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.T2zNLW_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);min-height:36px;margin:0;font-size:12px;line-height:18px}.T2zNLW_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.T2zNLW_grow{flex:1}.T2zNLW_titleRow{align-items:center;gap:10px;display:flex}.T2zNLW_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.T2zNLW_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.T2zNLW_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.T2zNLW_descTight{min-height:0}.T2zNLW_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.T2zNLW_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.T2zNLW_dot{vertical-align:2px;margin-left:5px}.T2zNLW_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.T2zNLW_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.T2zNLW_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.T2zNLW_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.T2zNLW_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.T2zNLW_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.T2zNLW_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite T2zNLW_sp;display:inline-flex}.T2zNLW_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.T2zNLW_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite T2zNLW_dshmPlug}@keyframes T2zNLW_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.T2zNLW_logoPlug,.T2zNLW_spin{animation:1.5s ease-in-out infinite T2zNLW_dshmPlugFade}}@keyframes T2zNLW_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes T2zNLW_sp{to{transform:rotate(360deg)}}.T2zNLW_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.T2zNLW_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.T2zNLW_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.T2zNLW_barWave{width:30%;animation:1.2s ease-in-out infinite T2zNLW_dshmSlide}@keyframes T2zNLW_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.T2zNLW_irow .T2zNLW_progress{margin-top:8px}.T2zNLW_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.T2zNLW_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.T2zNLW_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.T2zNLW_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;align-items:center;gap:10px;margin-bottom:8px;padding:12px 14px;display:flex}.T2zNLW_irowMissing{filter:grayscale();opacity:.5}.T2zNLW_irow>.T2zNLW_src,.T2zNLW_irow>.T2zNLW_owner,.T2zNLW_irow button{white-space:nowrap;flex-shrink:0}.T2zNLW_tabSearchRow{padding:0 4px 10px;display:flex}.T2zNLW_tabSearch{width:260px}.T2zNLW_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.T2zNLW_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.T2zNLW_specTagGit{color:#0b7285;background:#12a3c41f}.T2zNLW_specTagFile{color:#b07d1b;background:#f0b42924}.T2zNLW_backupCheckList .T2zNLW_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.T2zNLW_backupCheckList .T2zNLW_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.T2zNLW_staleAction{margin-top:8px}.T2zNLW_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.T2zNLW_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.T2zNLW_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.T2zNLW_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.T2zNLW_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.T2zNLW_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.T2zNLW_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.T2zNLW_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.T2zNLW_deprecate .T2zNLW_src{margin-left:8px}.T2zNLW_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.T2zNLW_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.T2zNLW_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.T2zNLW_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.T2zNLW_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.T2zNLW_switchOn .T2zNLW_switchKnob,.T2zNLW_switchMixed .T2zNLW_switchKnob{left:18px}.T2zNLW_switch:disabled{opacity:.5;cursor:default}.T2zNLW_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.T2zNLW_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.T2zNLW_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.T2zNLW_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.T2zNLW_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.T2zNLW_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.T2zNLW_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.T2zNLW_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.T2zNLW_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.T2zNLW_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.T2zNLW_groupMember .T2zNLW_nm{flex:1;min-width:0;font-size:12px}.T2zNLW_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.T2zNLW_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.T2zNLW_inlineInput{flex:1;min-width:120px}.T2zNLW_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.T2zNLW_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.T2zNLW_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.T2zNLW_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.T2zNLW_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.T2zNLW_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.T2zNLW_backupCard h3{margin:0;font-size:14px}.T2zNLW_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.T2zNLW_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.T2zNLW_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.T2zNLW_backupInput{box-sizing:border-box;width:100%}.T2zNLW_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.T2zNLW_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.T2zNLW_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.T2zNLW_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.T2zNLW_backupCheckList .T2zNLW_backupCheck{justify-content:space-between;gap:8px}.T2zNLW_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.T2zNLW_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.T2zNLW_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.T2zNLW_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.T2zNLW_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.T2zNLW_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.T2zNLW_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.T2zNLW_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.T2zNLW_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.T2zNLW_diagBundle:first-of-type{border-top:none;padding-top:0}.T2zNLW_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.T2zNLW_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.T2zNLW_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.T2zNLW_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.T2zNLW_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.T2zNLW_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.T2zNLW_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.T2zNLW_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.T2zNLW_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.T2zNLW_diagList{flex-direction:column;gap:6px;display:flex}.T2zNLW_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.T2zNLW_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.T2zNLW_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.T2zNLW_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.T2zNLW_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.T2zNLW_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.T2zNLW_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.T2zNLW_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.T2zNLW_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.T2zNLW_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.T2zNLW_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.T2zNLW_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.T2zNLW_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.T2zNLW_collapseTitle{flex:1;min-width:0}.T2zNLW_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.T2zNLW_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.T2zNLW_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.T2zNLW_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.T2zNLW_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.T2zNLW_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.T2zNLW_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.T2zNLW_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.T2zNLW_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.T2zNLW_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.T2zNLW_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.T2zNLW_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.T2zNLW_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.T2zNLW_setChevronOpen{transform:rotate(180deg)}.T2zNLW_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.T2zNLW_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.T2zNLW_setRow+.T2zNLW_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.T2zNLW_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.T2zNLW_setLabel{font-size:13px;line-height:20px}.T2zNLW_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.T2zNLW_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.T2zNLW_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.T2zNLW_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.T2zNLW_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.T2zNLW_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.T2zNLW_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.T2zNLW_setSegBtn:disabled{cursor:default;opacity:.5}.T2zNLW_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.T2zNLW_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}.T2zNLW_redeemWrap{flex-direction:column;gap:16px;padding:20px 16px;display:flex}.T2zNLW_redeemBox{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fafbfc);text-align:center;border-radius:12px;padding:24px 20px}.T2zNLW_redeemTitle{color:var(--dsw-alias-label-primary,#1f2328);margin-bottom:14px;font-size:16px;font-weight:600;line-height:24px}.T2zNLW_redeemRow{flex-wrap:wrap;justify-content:center;gap:8px;display:flex}.T2zNLW_redeemInput{flex:1;min-width:220px;max-width:420px}.T2zNLW_redeemDemo{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:12px;font-size:12px;line-height:18px}.T2zNLW_redeemError{color:var(--dsw-alias-state-error-primary,#dc2626);margin-top:12px;font-size:13px;line-height:20px}.T2zNLW_redeemOk{color:var(--dsw-alias-state-success-primary,#16a34a);margin-top:12px;font-size:13px;line-height:20px}.T2zNLW_unlockedTitle{color:var(--dsw-alias-label-primary,#1f2328);font-size:14px;font-weight:600;line-height:20px}.T2zNLW_unlockedList{flex-direction:column;gap:12px;display:flex}.T2zNLW_unlockedCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fafbfc);border-radius:12px;flex-direction:column;gap:8px;padding:14px 16px;display:flex}.T2zNLW_unlockedHead{flex-wrap:wrap;justify-content:space-between;align-items:baseline;gap:8px;display:flex}.T2zNLW_unlockedName{color:var(--dsw-alias-label-primary,#1f2328);font-size:14px;line-height:20px}.T2zNLW_unlockedAt{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.T2zNLW_unlockedDesc{color:var(--dsw-alias-label-secondary,#6b7280);white-space:pre-wrap;font-size:13px;line-height:20px}.T2zNLW_unlockedLinks{flex-direction:column;gap:4px;font-size:12px;line-height:18px;display:flex}.T2zNLW_unlockedLinks a{color:var(--dsw-alias-brand-primary,#4f7cff);text-decoration:none}.T2zNLW_unlockedLinks a:hover{text-decoration:underline}.T2zNLW_unlockedAuthors{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.T2zNLW_unlockedLabel{color:var(--dsw-alias-label-secondary,#6b7280);margin-right:6px;font-weight:600}.T2zNLW_unlockedItem{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:space-between;align-items:center;gap:8px;padding-top:8px;display:flex}.T2zNLW_unlockedItemName{color:var(--dsw-alias-label-primary,#1f2328);text-overflow:ellipsis;white-space:nowrap;font-size:13px;line-height:20px;overflow:hidden}.T2zNLW_unlockedInstalled{color:var(--dsw-alias-state-success-primary,#16a34a);font-size:12px;line-height:18px}.T2zNLW_unlockedBy{color:var(--dsw-alias-label-secondary,#6b7280);font-size:12px;line-height:18px}.T2zNLW_unlockedNote{color:var(--dsw-alias-label-primary,#1f2328);border-left:3px solid var(--dsw-alias-brand-primary,#4f7cff);margin-top:2px;padding-left:10px;font-size:13px;line-height:20px}.T2zNLW_unlockedUpdate{color:var(--dsw-alias-state-warning-primary,#d97706);font-size:12px;line-height:18px}.T2zNLW_unlockedVideo{flex-direction:column;gap:4px;margin-top:2px;display:flex}.T2zNLW_unlockedFrame{aspect-ratio:16/9;border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:#000;border-radius:10px;width:100%}.T2zNLW_unlockedExternal{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.T2zNLW_unlockedVideoLink{color:var(--dsw-alias-brand-primary,#4f7cff);font-size:13px;line-height:20px;text-decoration:none}.T2zNLW_unlockedVideoLink:hover{text-decoration:underline}.T2zNLW_unlockedSteps{flex-direction:column;gap:2px;margin-top:2px;display:flex}.T2zNLW_unlockedStep{color:var(--dsw-alias-label-primary,#1f2328);font-size:13px;line-height:20px}.T2zNLW_unlockedFaq{flex-direction:column;gap:4px;margin-top:2px;display:flex}.T2zNLW_unlockedFaqItem{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);padding-top:4px}.T2zNLW_unlockedFaqQ{color:var(--dsw-alias-label-primary,#1f2328);font-size:13px;font-weight:600;line-height:20px}.T2zNLW_unlockedFaqA{color:var(--dsw-alias-label-secondary,#6b7280);white-space:pre-wrap;font-size:12px;line-height:18px}.T2zNLW_unlockedContact{flex-direction:column;gap:4px;margin-top:2px;display:flex}.T2zNLW_unlockedContactRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.T2zNLW_unlockedContactKey{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:18px}.T2zNLW_unlockedContactValue{color:var(--dsw-alias-label-primary,#1f2328);text-overflow:ellipsis;font-size:13px;line-height:20px;overflow:hidden}a.T2zNLW_unlockedContactValue{color:var(--dsw-alias-brand-primary,#4f7cff);text-decoration:none}a.T2zNLW_unlockedContactValue:hover{text-decoration:underline}.T2zNLW_unlockedHours{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.T2zNLW_unlockedAbout{color:var(--dsw-alias-label-tertiary,#8b93a1);border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);padding-top:6px;font-size:11px;line-height:16px}";
		...
		var Market_module_css_default = {
			"act": "T2zNLW_act",
			"actBroken": "T2zNLW_actBroken",
			"actLive": "T2zNLW_actLive",
			"actWarn": "T2zNLW_actWarn",
			"actWhy": "T2zNLW_actWhy",
			"assignRow": "T2zNLW_assignRow",
			"assignSelect": "T2zNLW_assignSelect",
			"av": "T2zNLW_av",
			"backupActions": "T2zNLW_backupActions",
			"backupCard": "T2zNLW_backupCard",
			"backupCheck": "T2zNLW_backupCheck",
			"backupCheckList": "T2zNLW_backupCheckList",
			"backupGrid": "T2zNLW_backupGrid",
			"backupInput": "T2zNLW_backupInput",
			"backupMessage": "T2zNLW_backupMessage",
			"backupWarn": "T2zNLW_backupWarn",
			"banner": "T2zNLW_banner",
			"bannerHint": "T2zNLW_bannerHint",
			"bannerIcon": "T2zNLW_bannerIcon",
			"bar": "T2zNLW_bar",
			"barFill": "T2zNLW_barFill",
			"barWave": "T2zNLW_barWave",
			"body": "T2zNLW_body",
			"byline": "T2zNLW_byline",
			"card": "T2zNLW_card",
			"cats": "T2zNLW_cats",
			"catsCollapsed": "T2zNLW_catsCollapsed",
			"catsRow": "T2zNLW_catsRow",
			"catsToggle": "T2zNLW_catsToggle",
			"catsWrap": "T2zNLW_catsWrap",
			"cmd": "T2zNLW_cmd",
			"collapseBody": "T2zNLW_collapseBody",
			"collapseHead": "T2zNLW_collapseHead",
			"collapseIcon": "T2zNLW_collapseIcon",
			"collapseTitle": "T2zNLW_collapseTitle",
			"depBadge": "T2zNLW_depBadge",
			"depLine": "T2zNLW_depLine",
			"deprecate": "T2zNLW_deprecate",
			"desc": "T2zNLW_desc",
			"descTight": "T2zNLW_descTight",
			"diagAlert": "T2zNLW_diagAlert",
			"diagArrow": "T2zNLW_diagArrow",
			"diagBadgeCommunity": "T2zNLW_diagBadgeCommunity",
			"diagBadgeOfficial": "T2zNLW_diagBadgeOfficial",
			"diagBadgeShadow": "T2zNLW_diagBadgeShadow",
			"diagBundle": "T2zNLW_diagBundle",
			"diagCount": "T2zNLW_diagCount",
			"diagEmpty": "T2zNLW_diagEmpty",
			"diagIndex": "T2zNLW_diagIndex",
			"diagKey": "T2zNLW_diagKey",
			"diagList": "T2zNLW_diagList",
			"diagMeta": "T2zNLW_diagMeta",
			"diagPage": "T2zNLW_diagPage",
			"diagRow": "T2zNLW_diagRow",
			"diagSection": "T2zNLW_diagSection",
			"diagSummary": "T2zNLW_diagSummary",
			"diagSummaryItem": "T2zNLW_diagSummaryItem",
			"diagSummaryMeta": "T2zNLW_diagSummaryMeta",
			"diagVal": "T2zNLW_diagVal",
			"dot": "T2zNLW_dot",
			"dragging": "T2zNLW_dragging",
			"dragHandle": "T2zNLW_dragHandle",
			"dragOver": "T2zNLW_dragOver",
			"dshmPlug": "T2zNLW_dshmPlug",
			"dshmPlugFade": "T2zNLW_dshmPlugFade",
			"dshmSlide": "T2zNLW_dshmSlide",
			"empty": "T2zNLW_empty",
			"err": "T2zNLW_err",
			"fab": "T2zNLW_fab",
			"fabLabel": "T2zNLW_fabLabel",
			"fabModalCard": "T2zNLW_fabModalCard",
			"fabModalHead": "T2zNLW_fabModalHead",
			"fabModalPanel": "T2zNLW_fabModalPanel",
			"fabModalTitle": "T2zNLW_fabModalTitle",
			"fixFallback": "T2zNLW_fixFallback",
			"fixFallbackText": "T2zNLW_fixFallbackText",
			"foot": "T2zNLW_foot",
			"grid": "T2zNLW_grid",
			"groupActions": "T2zNLW_groupActions",
			"groupAddPanel": "T2zNLW_groupAddPanel",
			"groupCreate": "T2zNLW_groupCreate",
			"groupHead": "T2zNLW_groupHead",
			"groupHint": "T2zNLW_groupHint",
			"groupMember": "T2zNLW_groupMember",
			"groupMembers": "T2zNLW_groupMembers",
			"groupName": "T2zNLW_groupName",
			"groupRow": "T2zNLW_groupRow",
			"grow": "T2zNLW_grow",
			"head": "T2zNLW_head",
			"hiddenFile": "T2zNLW_hiddenFile",
			"inlineInput": "T2zNLW_inlineInput",
			"installBtn": "T2zNLW_installBtn",
			"irow": "T2zNLW_irow",
			"irowMissing": "T2zNLW_irowMissing",
			"loading": "T2zNLW_loading",
			"logoMark": "T2zNLW_logoMark",
			"logoPlug": "T2zNLW_logoPlug",
			"meta": "T2zNLW_meta",
			"metaInline": "T2zNLW_metaInline",
			"modalNote": "T2zNLW_modalNote",
			"nm": "T2zNLW_nm",
			"okState": "T2zNLW_okState",
			"on": "T2zNLW_on",
			"orphBadge": "T2zNLW_orphBadge",
			"orphRow": "T2zNLW_orphRow",
			"ovArrow": "T2zNLW_ovArrow",
			"ovByTag": "T2zNLW_ovByTag",
			"ovFrom": "T2zNLW_ovFrom",
			"ovRow": "T2zNLW_ovRow",
			"owner": "T2zNLW_owner",
			"pageEllipsis": "T2zNLW_pageEllipsis",
			"pageInfo": "T2zNLW_pageInfo",
			"pager": "T2zNLW_pager",
			"pagerPages": "T2zNLW_pagerPages",
			"panelNote": "T2zNLW_panelNote",
			"pct": "T2zNLW_pct",
			"progress": "T2zNLW_progress",
			"redeemBox": "T2zNLW_redeemBox",
			"redeemDemo": "T2zNLW_redeemDemo",
			"redeemError": "T2zNLW_redeemError",
			"redeemInput": "T2zNLW_redeemInput",
			"redeemOk": "T2zNLW_redeemOk",
			"redeemRow": "T2zNLW_redeemRow",
			"redeemTitle": "T2zNLW_redeemTitle",
			"redeemWrap": "T2zNLW_redeemWrap",
			"repoLink": "T2zNLW_repoLink",
			"root": "T2zNLW_root",
			"row1": "T2zNLW_row1",
			"sectAction": "T2zNLW_sectAction",
			"sectionOverview": "T2zNLW_sectionOverview",
			"setActions": "T2zNLW_setActions",
			"setBetaTag": "T2zNLW_setBetaTag",
			"setBody": "T2zNLW_setBody",
			"setCard": "T2zNLW_setCard",
			"setCardOpen": "T2zNLW_setCardOpen",
			"setCheck": "T2zNLW_setCheck",
			"setChevron": "T2zNLW_setChevron",
			"setChevronOpen": "T2zNLW_setChevronOpen",
			"setConfirm": "T2zNLW_setConfirm",
			"setDanger": "T2zNLW_setDanger",
			"setDesc": "T2zNLW_setDesc",
			"setHeader": "T2zNLW_setHeader",
			"setHeadText": "T2zNLW_setHeadText",
			"setHint": "T2zNLW_setHint",
			"setLabel": "T2zNLW_setLabel",
			"setLabelBox": "T2zNLW_setLabelBox",
			"setName": "T2zNLW_setName",
			"setRow": "T2zNLW_setRow",
			"setSeg": "T2zNLW_setSeg",
			"setSegBtn": "T2zNLW_setSegBtn",
			"setSegOn": "T2zNLW_setSegOn",
			"shot": "T2zNLW_shot",
			"shots": "T2zNLW_shots",
			"sp": "T2zNLW_sp",
			"spec": "T2zNLW_spec",
			"specTag": "T2zNLW_specTag",
			"specTagFile": "T2zNLW_specTagFile",
			"specTagGit": "T2zNLW_specTagGit",
			"spin": "T2zNLW_spin",
			"src": "T2zNLW_src",
			"staleAction": "T2zNLW_staleAction",
			"star": "T2zNLW_star",
			"stickyHead": "T2zNLW_stickyHead",
			"sub": "T2zNLW_sub",
			"swatches": "T2zNLW_swatches",
			"switch": "T2zNLW_switch",
			"switchKnob": "T2zNLW_switchKnob",
			"switchMixed": "T2zNLW_switchMixed",
			"switchOn": "T2zNLW_switchOn",
			"tab": "T2zNLW_tab",
			"tabs": "T2zNLW_tabs",
			"tabSearch": "T2zNLW_tabSearch",
			"tabSearchRow": "T2zNLW_tabSearchRow",
			"tag": "T2zNLW_tag",
			"themesGrid": "T2zNLW_themesGrid",
			"tierAgentic": "T2zNLW_tierAgentic",
			"tierAppearance": "T2zNLW_tierAppearance",
			"tiersRow": "T2zNLW_tiersRow",
			"tierTag": "T2zNLW_tierTag",
			"tierUtility": "T2zNLW_tierUtility",
			"title": "T2zNLW_title",
			"titleRow": "T2zNLW_titleRow",
			"top": "T2zNLW_top",
			"topBtn": "T2zNLW_topBtn",
			"unlockedAbout": "T2zNLW_unlockedAbout",
			"unlockedAt": "T2zNLW_unlockedAt",
			"unlockedAuthors": "T2zNLW_unlockedAuthors",
			"unlockedBy": "T2zNLW_unlockedBy",
			"unlockedCard": "T2zNLW_unlockedCard",
			"unlockedContact": "T2zNLW_unlockedContact",
			"unlockedContactKey": "T2zNLW_unlockedContactKey",
			"unlockedContactRow": "T2zNLW_unlockedContactRow",
			"unlockedContactValue": "T2zNLW_unlockedContactValue",
			"unlockedDesc": "T2zNLW_unlockedDesc",
			"unlockedExternal": "T2zNLW_unlockedExternal",
			"unlockedFaq": "T2zNLW_unlockedFaq",
			"unlockedFaqA": "T2zNLW_unlockedFaqA",
			"unlockedFaqItem": "T2zNLW_unlockedFaqItem",
			"unlockedFaqQ": "T2zNLW_unlockedFaqQ",
			"unlockedFrame": "T2zNLW_unlockedFrame",
			"unlockedHead": "T2zNLW_unlockedHead",
			"unlockedHours": "T2zNLW_unlockedHours",
			"unlockedInstalled": "T2zNLW_unlockedInstalled",
			"unlockedItem": "T2zNLW_unlockedItem",
			"unlockedItemName": "T2zNLW_unlockedItemName",
			"unlockedLabel": "T2zNLW_unlockedLabel",
			"unlockedLinks": "T2zNLW_unlockedLinks",
			"unlockedList": "T2zNLW_unlockedList",
			"unlockedName": "T2zNLW_unlockedName",
			"unlockedNote": "T2zNLW_unlockedNote",
			"unlockedStep": "T2zNLW_unlockedStep",
			"unlockedSteps": "T2zNLW_unlockedSteps",
			"unlockedTitle": "T2zNLW_unlockedTitle",
			"unlockedUpdate": "T2zNLW_unlockedUpdate",
			"unlockedVideo": "T2zNLW_unlockedVideo",
			"unlockedVideoLink": "T2zNLW_unlockedVideoLink",
			"version": "T2zNLW_version",
			"viewBar": "T2zNLW_viewBar",
			"viewBtn": "T2zNLW_viewBtn",
			"viewOn": "T2zNLW_viewOn",
			"warnLine": "T2zNLW_warnLine"
		};
		//#endregion
