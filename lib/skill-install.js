...
export function skillsRoot(profileDirectory) {
...
export function readInstalledSkills(profileDirectory) {
 ...
 */
export async function installSkill(profileDirectory, entry) {
...
export function uninstallSkill(profileDirectory, name) {
