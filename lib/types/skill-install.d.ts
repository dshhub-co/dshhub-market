...
export declare function skillsRoot(profileDirectory: string): string;
/** Installed skill packages: package name → record. */
export declare function readInstalledSkills(profileDirectory: string): Record<string, InstalledSkill>;
 ...
 */
export declare function installSkill(profileDirectory: string, entry: RegistryPlugin): Promise<InstalledSkill>;
/** Remove every skill dir a package brought in, then its state record. */
export declare function uninstallSkill(profileDirectory: string, name: string): boolean;
