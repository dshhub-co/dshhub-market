...
export const zh = {
  ...
  // kind=app 可部署应用（上架时已过 AI 审核；部署零门槛）
...
export const en: Record<MarketKey, string> = {
  ...
  // kind=app deployable apps (AI-reviewed at listing time; zero-friction deploy)
  ...
  // Quick-deploy FAB (small button beside the market store entry + popup list)
